...
# Simple proxy test script that extracts ports directly from Docker

URL="${1:-https://ifconfig.io}"

echo "🔍 Finding and testing all proxy containers..."
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"

# Get ports directly from docker ps
...
echo "Found $TOTAL proxy containers"
